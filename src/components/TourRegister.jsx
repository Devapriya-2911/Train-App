                        ...
                        <div className="row g-3">
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <select name="" id="" class="form-select">
                                    ...
                                    <option value="1 lakh">1 hundred</option>
                                    <option value="2 lakh">2 hundred</option>
                                    <option value="3 lakh">3 hundred</option>
                                    <option value="4 lakh">4 hundred</option>
                                    <option value="5 lakh">Fifty </option>
                                    <option value="More than 5 lakh">More than 4 hundred</option>
